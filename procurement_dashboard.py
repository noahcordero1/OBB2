...
# Page configuration
st.set_page_config(
    page_title="ÖBB Procurement Intelligence",
    page_icon="📊",
    layout="wide",
...
def load_data():
    ...
    try:
        df = pd.read_excel('extended.xlsx')
        ...
        st.error("❌ Data file 'extended.xlsx' not found. Please run the multi-subsidiary scraper first.")
        return pd.DataFrame()
